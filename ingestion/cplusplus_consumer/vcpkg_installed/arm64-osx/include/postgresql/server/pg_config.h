...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' 'PG_SYSROOT=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/Users/boubalkaly/vcpkg/installed/arm64-osx' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/cc -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk -fPIC -mmacosx-version-min=15.1 -g -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk -DNDEBUG -fPIC -mmacosx-version-min=15.1 -O3' 'CFLAGS=-fPIC -mmacosx-version-min=15.1 -O3' 'LDFLAGS=-L/Users/boubalkaly/vcpkg/installed/arm64-osx/lib -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk -mmacosx-version-min=15.1' 'CPPFLAGS=-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk -DNDEBUG' 'CXX=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++' 'CXXFLAGS=-fPIC -mmacosx-version-min=15.1 -O3' 'PKG_CONFIG=/opt/homebrew/bin/pkg-config' 'PKG_CONFIG_PATH=/Users/boubalkaly/vcpkg/packages/libpq_arm64-osx/lib/pkgconfig:/Users/boubalkaly/vcpkg/packages/libpq_arm64-osx/share/pkgconfig:/Users/boubalkaly/vcpkg/installed/arm64-osx/lib/pkgconfig:/Users/boubalkaly/vcpkg/installed/arm64-osx/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.9 on aarch64-apple-darwin24.1.0, compiled by Apple clang version 16.0.0 (clang-1600.0.26.6), 64-bit"
